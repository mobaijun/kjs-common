 ...
 * class name: UnitConverter<br>
 * class description: <br>
 * 1.将带单位的时间，大小字符串转换为数字. copy from Facebook
 * 2.将数字转为带单位的字符串
 * <a href="https://github.com/facebook/jcommon/blob/master/config/src/main/java/com/facebook/config/ConfigUtil.java">...</a>
 *
 * @author MoBaiJun 2022/12/9 8:46
 */
