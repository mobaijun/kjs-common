...
//  * class name: SystemPropertiesUtils<br>
//  * class description: 关于SystemProperties的工具类<br>
//  * 1. 统一风格的读取系统变量到各种数据类型，其中Boolean.readBoolean的风格不统一，Double则不支持，都进行了扩展.<br>
//  * 2. 简单的合并系统变量(-D)，环境变量 和默认值，以系统变量优先，在未引入Commons Config时使用.<br>
//  * 3. Properties 本质上是一个HashTable，每次读写都会加锁，所以不支持频繁的System.getProperty(name)来检查系统内容变化 因此扩展了一个ListenableProperties,<br>
//  * 在其所关心的属性变化时进行通知.<br>
//  *
//  * @author MoBaiJun 2022/12/8 17:40
//  */
