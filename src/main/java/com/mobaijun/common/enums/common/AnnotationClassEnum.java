 ...
 */
@Getter
public enum AnnotationClassEnum {
    ...
    AnnotationClassEnum(String shortName, String fullPath) {
    ...
    public static List<String> resolveResources(List<String> resources) {
        if (!resources.isEmpty()) {
            ...
            for (String source : resources) {
                AnnotationClassEnum result = null;
                // 判断是否包含在枚举类中
                for (AnnotationClassEnum annotationClass : annotationClassEnums) {
